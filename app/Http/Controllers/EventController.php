...
class EventController extends Controller
{
        ...
        public function index(Request $request)
    {
        try {
            ...
            return view('admin.events', compact('events', 'searchTerm'));
        } catch (\Exception $e) {
            \Log::error('Error fetching events: ' . $e->getMessage());
            return redirect()->route('admin.dashboard')->with('error', 'Unable to retrieve events.');
        }
    }
    ...
    {
        return view('admin.add-event'); // This will load the add event form (add-event.blade.php)
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.editEvent', compact('event')); // Pass the event data to the edit form
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.event_details', compact('event')); // Pass event data to the view
    }
