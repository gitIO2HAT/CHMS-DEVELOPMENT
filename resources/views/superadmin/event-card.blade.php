        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-8 space-y-4 sm:space-y-0">
            ...
            <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
                @if(auth()->check() && auth()->user()->role === 'superadmin')
                    <a href="{{ route('superadmin.events.create') }}" class="bg-blue-600 text-white px-4 py-2 text-sm rounded-md hover:bg-blue-700 transition duration-300 ease-in-out flex items-center">
                ...
                <div class="event-container flex flex-col sm:flex-row space-y-4 sm:space-x-6 p-6 border rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out w-full mb-6">
                    ...
                    <div class="flex-1 flex flex-col space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            @if(auth()->check() && auth()->user()->role === 'superadmin')
                                <div class="space-x-4">
                                    <a href="{{ route('superadmin.events.edit', $event->id) }}" class="text-yellow-500 cursor-pointer hover:text-yellow-600 transition duration-300 ease-in-out">
