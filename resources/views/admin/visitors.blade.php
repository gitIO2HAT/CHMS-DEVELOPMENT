        ...
        <div class="max-w-6xl w-full px-6 py-6 bg-white rounded-lg shadow-md">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('admin.visitors.create') }}" class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition duration-200">
                        Add Visitor
                    </a>
                    ...
                    <form method="GET" action="{{ route('admin.visitors.index') }}" class="flex flex-wrap gap-2 items-center">
                    <!-- Filter by Gender -->
                        ...
                        @foreach($visitors as $visitor)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center flex justify-center space-x-2">
                                    <a href="{{ route('admin.visitors.edit', $visitor->id) }}" class="text-yellow-500 hover:underline">Edit</a>
                                    <form action="{{ route('admin.visitors.destroy', $visitor->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this visitor?')" class="inline-block">
                                        @csrf
                                        @method('DELETE')
