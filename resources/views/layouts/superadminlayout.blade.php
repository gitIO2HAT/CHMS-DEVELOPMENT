...
<body>
    <div class="flex h-screen">
        ...
        <div id="sidebar" class="bg-gray-900 text-white shadow-xl">
            <div class="flex items-center mb-10 logo-container">
                ...
                <div class="pt-7">
                    ...
                    <p class="text-sm text-gray-400 mt-1">Superadmin Dashboard</p>
                </div>
            </div>
            <nav class="sidebar-content space-y-3 px-3">
                <a href="{{ route('superadmin.dashboard') }}" class="hover:bg-blue-500">
                    <i class="fas fa-tachometer-alt mr-3"></i> Dashboard
                </a>
                <a href="{{ route('superadmin.visitors.index') }}" class="hover:bg-blue-500">
                    <i class="fas fa-users mr-3"></i> Visitors
                </a>
                <a href="{{ route('superadmin.events.index') }}" class="hover:bg-blue-500">
                    <i class="fas fa-calendar-alt mr-3"></i> Events
                </a>
                <a href="{{ route('superadmin.notifications.index') }}" class="hover:bg-blue-500">
                ...
                <li class="mb-2 mt-0 px-3 relative group">
                    ...
                    <ul class="absolute hidden group-hover:block bg-blue-600 text-white mt-0 p-2 rounded shadow-lg">
                        <li><a href="{{ route('superadmin.participation-requests.requests') }}" class="block p-2 hover:bg-blue-500 rounded">Participation Requests</a></li>
                        <li><a href="{{ route('superadmin.participants-list') }}" class="block p-2 hover:bg-blue-500 rounded">List of Participants</a></li>
                    </ul>
                </li>
                <!-- Logout Form -->
        ...
        <!-- Main Content -->
        <div id="main-content" class="w-full bg-gray-50 p-6 flex flex-col" style="height: calc(115vh - 80px); overflow-y: auto;">
            <!-- Header Section -->
            ...
            <footer class="bg-gray-800 text-white text-center py-0">
                <p>&copy; {{ date('l, F j, Y') }} Church Management System. All Rights Reserved.</p>
            </footer>
        </div>
    </div>
